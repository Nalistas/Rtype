\chapter{minipass}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README}{}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README}\index{minipass@{minipass}}
\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4446}%
\Hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4446}%
...
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4447}{}\doxysection{\texorpdfstring{Usage in Type\+Script}{Usage in Type\+Script}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4447}
...
Emitting/handling events that aren\textquotesingle{}t declared in this way is fine, but the arguments will be typed as {\ttfamily unknown}.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4448}{}\doxysection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4448}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4449}{}\doxysubsection{\texorpdfstring{Timing}{Timing}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4449}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4450}{}\doxysubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4450}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4451}{}\doxysubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4451}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4452}{}\doxysubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4452}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4453}{}\doxysubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4453}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4454}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4454}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4455}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4455}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4456}{}\doxysubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4456}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4457}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4457}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4458}{}\doxysubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4458}
...
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4459}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4459}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4460}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4460}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4461}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4461}
...
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4462}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4462}
...
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4463}{}\doxysubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4463}
...
\end{DoxyItemize}\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4464}{}\doxysection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4464}
Here are some examples of things you can do with Minipass streams.\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4465}{}\doxysubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4465}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4466}{}\doxysubsection{\texorpdfstring{collecting}{collecting}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4466}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4467}{}\doxysubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4467}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4468}{}\doxysubsection{\texorpdfstring{iteration}{iteration}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4468}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4469}{}\doxysubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4469}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4470}{}\doxysubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4470}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4471}{}\doxysubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4471}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4472}{}\doxysubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4472}
...
\end{DoxyCode}
\hypertarget{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4473}{}\doxysubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{md__2home_2solype_2delivery_2current__days_2Mannheim_2front_2node__modules_2minipass_2README_autotoc_md4473}
